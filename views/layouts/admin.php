...
if (isset($this->params['breadcrumbs'])) {
    ...
    if (isset($this->params['breadcrumbs_only_last'])) {
        $panelBreadcrumbs = '';
    }
...
<?php
    ...
    echo Nav::widget([
        ...
        'items' => array_filter([
            ['label' => Yii::t('app', 'NAV_HOME'), 'url' => ['/administrator']],
            ...
            ['label' => Yii::t('app', 'NAV_ADMIN_REGIONS'), 'url' => ['/admin/region/default/index'], 'active' => $context->module->id == 'region'],
            ['label' => Yii::t('app', 'NAV_ADMIN_WAREHOUSES'), 'url' => ['/admin/warehouse/default/index'], 'active' => $context->module->id == 'warehouse'],
            ['label' => Yii::t('app', 'NAV_ADMIN_ORGANIZATIONS'), 'url' => ['/admin/organization/default/index'], 'active' => $context->module->id == 'organization'],
