...
function factory(classie) {
	...
	SelectFx.prototype._init = function() {
		...
		this.hasDefaultPlaceholder = this.el.options[0].disabled;

		// get selected option (either the first option with attr selected or just the first option)
		this.selectedOpt = selectedOpt || this.el.querySelector( 'option' );
                this.disabledOpt = this.el.options[0];
	...
	SelectFx.prototype._createSelectEl = function(elem) {
		...
		this.selEl.innerHTML = '<span class="cs-placeholder">' + (this.hasDefaultPlaceholder ? this.disabledOpt.textContent : this.selectedOpt.textContent) + '</span>' + opts_el;
	...
	SelectFx.prototype._toggleSelect = function() {
		...
		if( this._isOpen() ) {
			...
			if( this.hasDefaultPlaceholder && this.options.stickyPlaceholder ) {
				...
				this.selPlaceholder.textContent = this.disabledOpt.textContent;
			}
