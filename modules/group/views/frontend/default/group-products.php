...
$ajaxUrl = Yii::$app->urlManager->createUrl(['/group/default/group-product-change', 'id' => $model->id]);
$this->registerJs('
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body text-center">
            <div class="btn-group" role="group">
                ...
                <?= Html::a('<span class="glyphicon glyphicon-leaf"></span><br>' . Module::t('group', 'GROUP_PRODUCTS_MANAGE'), ['group-products', 'id' => $model->id], ['class' => 'btn btn-primary active']) ?>
