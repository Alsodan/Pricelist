    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body text-center">
            <div class="btn-group" role="group">
                <?= Html::a('<span class="glyphicon glyphicon-pencil"></span><br>' . Module::t('warehouse', 'WAREHOUSE_UPDATE'), ['update', 'id' => $warehouse->id], ['class' => 'btn btn-primary']) ?>
                <?= Html::a('<span class="glyphicon glyphicon-user"></span><br>' . Module::t('warehouse', 'WAREHOUSE_USERS_MANAGE'), ['users', 'id' => $warehouse->id], ['class' => 'btn btn-primary']) ?>
                <?= Html::a('<span class="glyphicon glyphicon-gift"></span><br>' . Module::t('warehouse', 'WAREHOUSE_PRODUCTS_MANAGE'), ['products', 'id' => $warehouse->id], ['class' => 'btn btn-primary']) ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="text-center">
                    <h4><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<b><?= Module::t('warehouse', 'USERS') ?></b></h4>
                </div>
                <?= GridView::widget([
                    'dataProvider' => $users,
                    'showHeader' => false,
